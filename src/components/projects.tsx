...
export function Projects() {
  ...
  return (
    ...
    >
      {/* Grid Background */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#10b98108_1px,transparent_1px),linear-gradient(to_bottom,#10b98108_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#00ff0008_1px,transparent_1px),linear-gradient(to_bottom,#00ff0008_1px,transparent_1px)] bg-[size:60px_60px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]" />
        ...
        >
          ...
          >
            ...
            >
              ...
              Portfolio of <span className="text-green-600 dark:text-green-400">innovative projects</span> showcasing 
              <span className="text-blue-600 dark:text-blue-400"> modern tech</span> and 
              <span className="text-purple-600 dark:text-purple-400"> cutting-edge solutions</span>
            </motion.p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mb-16">
            <Card className="border border-gray-300 dark:border-gray-700 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700">
                ...
                <span className="text-xs text-gray-600 dark:text-gray-400 ml-2 font-mono">projects@portfolio:~$</span>
              </div>
          ...
          >
            <div className="text-center mb-8">
              <h3 className="text-xl font-mono text-green-600 dark:text-green-400 mb-4">$ ls categories/</h3>
            </div>
            
            <Card className="border border-gray-300 dark:border-gray-700 bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg p-4">
                  ...
                  return (
                    <motion.button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-mono font-medium transition-all duration-300 border ${
                        isActive 
                          ? 'bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400 border-green-500/50 dark:border-green-500/30 shadow-md' 
                          : 'bg-gray-100 dark:bg-gray-800/50 text-gray-600 dark:text-gray-300 border-gray-400 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-700/50'
                      }`}
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      ...
                      <Badge 
                        ...
                        className={`ml-1 font-mono text-xs ${
                          isActive 
                            ? 'bg-green-200 dark:bg-green-400/20 text-green-700 dark:text-green-300 border-green-500/50 dark:border-green-400/30' 
                            : 'bg-gray-200 dark:bg-gray-700/50 text-gray-500 dark:text-gray-400 border-gray-400 dark:border-gray-600'
                        }`}
                      >
                        {category.count}
                      </Badge>
          ...
          {featuredProjects.length > 0 && (
            <div className="mb-20">
              <motion.h3 
                variants={itemVariants}
                className="text-2xl font-mono font-bold mb-8 text-green-600 dark:text-green-400 flex items-center gap-2"
              >
                ...
                <AnimatePresence mode="wait">
                  {featuredProjects.map((project, index) => (
                    <motion.div
                      ...
                      className="group"
                    >
                      <Card className="overflow-hidden border border-gray-300 dark:border-gray-700 bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm hover:bg-gray-50/95 dark:hover:bg-gray-800/90 hover:shadow-2xl transition-all duration-500 h-full">
                        {/* Terminal Command Header */}
                        <div className="px-4 py-2 bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 font-mono text-xs">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-green-600 dark:text-green-400">$</span>
                            <span className="text-gray-800 dark:text-white">{project.command}</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <Badge 
                                ...
                                className={`text-xs font-mono ${
                                  project.status === 'PRODUCTION' ? 'bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400 border-green-500/50 dark:border-green-500/30' :
                                  project.status === 'LIVE' ? 'bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 border-blue-500/50 dark:border-blue-500/30' :
                            ...
                            <span className="text-gray-600 dark:text-gray-400">{project.deployment}</span>
                          </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden aspect-video">
                          ...
                          >
                            <div className="absolute bottom-4 left-4 right-4">
                              <div className="flex gap-3">
                                <Button size="sm" className="flex-1 bg-green-500/20 backdrop-blur-sm hover:bg-green-500/30 text-green-300 border border-green-500/30 font-mono">
                                  <ExternalLink className="w-4 h-4 mr-2" />
                                  ./demo.sh
                                </Button>
                                <Button size="sm" className="flex-1 bg-blue-500/20 backdrop-blur-sm hover:bg-blue-500/30 text-blue-300 border border-blue-500/30 font-mono">
                          ...
                          <div className="absolute top-4 left-4">
                            <Badge variant="outline" className="bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm text-green-600 dark:text-green-400 border-green-500/50 dark:border-green-500/30 font-mono">
                              {project.category}
                            </Badge>
                          </div>
                        </div>
                        ...
                        <CardHeader className="pb-3">
                          <div className="flex justify-between items-start mb-2">
                            <CardTitle className="text-xl font-mono text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors line-clamp-1">
                              {project.title}
                            </CardTitle>
                            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 shrink-0 font-mono">
                        ...
                        <CardContent className="space-y-6">
                          {/* Tech Stack */}
                          <div>
                            <h4 className="text-sm font-semibold mb-3 flex items-center gap-2 text-green-600 dark:text-green-400 font-mono">
                              <FileCode className="w-4 h-4" />
                              dependencies/
                            </h4>
                            <div className="flex flex-wrap gap-1">
                              {project.tech.slice(0, 5).map((tech) => (
                                <Badge key={tech} variant="secondary" className="text-xs font-mono bg-gray-100 dark:bg-gray-800/50 text-gray-600 dark:text-gray-300">
                                  {tech}
                                </Badge>
                              ))}
                          ...
                          {/* Key Features */}
                          <div>
                            <h4 className="text-sm font-semibold mb-3 flex items-center gap-2 text-blue-600 dark:text-blue-400 font-mono">
                          ...
                          {/* Project Stats */}
                          <div>
                            <h4 className="text-sm font-semibold mb-3 text-purple-600 dark:text-purple-400 font-mono">metrics.json</h4>
                            <div className="grid grid-cols-3 gap-3">
                              {Object.entries(project.stats).map(([key, value]) => (
                                <div key={key} className="text-center p-2 bg-gray-100 dark:bg-gray-800/30 rounded border border-gray-300 dark:border-gray-700">
          ...
          {regularProjects.length > 0 && (
            <div>
              <motion.h3 
                variants={itemVariants}
                className="text-2xl font-mono font-bold mb-8 text-green-600 dark:text-green-400"
              >
                $ ls other_projects/
              </motion.h3>
                ...
                <AnimatePresence mode="wait">
                  {regularProjects.map((project, index) => (
                    <motion.div
                      ...
                      transition={{ type: "spring", stiffness: 300 }}
                    >
                      <Card className="group border border-gray-300 dark:border-gray-700 bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm hover:bg-gray-50/95 dark:hover:bg-gray-800/90 hover:shadow-lg transition-all duration-300 h-full">
                        {/* Terminal Header */}
                        <div className="px-3 py-2 bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 font-mono text-xs">
                          <div className="flex items-center gap-2">
                            <span className="text-green-600 dark:text-green-400">$</span>
                            <span className="text-gray-800 dark:text-white truncate">{project.command}</span>
                          </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden aspect-video">
                          ...
                          <div className="absolute top-3 right-3">
                            <Badge variant="outline" className="bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm text-green-600 dark:text-green-400 border-green-500/50 dark:border-green-500/30 text-xs font-mono">
                              {project.category}
                            </Badge>
                          </div>
                        </div>
                        ...
                        <CardHeader className="pb-3">
                          <div className="flex justify-between items-start">
                            <CardTitle className="text-lg font-mono text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors line-clamp-1">
                              {project.title}
                            </CardTitle>
                            <div className="text-xs text-gray-500 dark:text-gray-400 font-mono">{project.year}</div>
                          </div>
                        ...
                        <CardContent className="space-y-4">
                          ...
                          {/* Action Buttons */}
                          <div className="flex gap-2">
                            <Button size="sm" variant="outline" className="flex-1 text-xs font-mono bg-green-100 dark:bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/50 dark:border-green-500/30 hover:bg-green-200 dark:hover:bg-green-500/20">
                              <ExternalLink className="w-3 h-3 mr-1" />
                              ./demo
                            </Button>
                            <Button size="sm" variant="outline" className="flex-1 text-xs font-mono bg-blue-100 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/50 dark:border-blue-500/30 hover:bg-blue-200 dark:hover:bg-blue-500/20">
