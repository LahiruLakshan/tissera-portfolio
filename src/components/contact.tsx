        ...
        >
          ...
          >
            ...
            >
              ...
              Let's <span className="text-blue-400">build something amazing</span> together
            </motion.p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mb-16">
            <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/90 dark:bg-gray-900/90 bg-white/90 backdrop-blur-sm shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300">
                ...
                <span className="text-xs text-gray-400 dark:text-gray-400 text-gray-600 ml-2 font-mono">contact@portfolio:~$</span>
              </div>
          ...
          >
            <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/80 dark:bg-gray-900/80 bg-white/80 backdrop-blur-sm shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <motion.div 
              ...
              className="space-y-8"
            >
              <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/90 dark:bg-gray-900/90 bg-white/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500">
                {/* Terminal Header */}
                <div className="flex items-center gap-2 px-4 py-3 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300">
                  <div className="flex gap-2">
                    <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                  ...
                  <span className="text-xs text-gray-400 dark:text-gray-400 text-gray-600 ml-2 font-mono">message-form.tsx</span>
                </div>

                <CardHeader className="pb-6">
                  <CardTitle className="text-2xl font-mono text-white dark:text-white text-gray-900 flex items-center gap-3">
                    <motion.div
                  ...
                  <p className="text-gray-300 dark:text-gray-300 text-gray-600 font-mono">
                    <span className="text-gray-500 dark:text-gray-500 text-gray-400">// </span>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.div
                        ...
                        transition={{ type: "spring", stiffness: 300 }}
                      >
                        <label className="text-sm font-medium mb-2 block text-green-400 font-mono">const name = *</label>
                        <Input
                          name="name"
                          value={formData.name}
                          ...
                          required
                          className="border-2 border-gray-600 dark:border-gray-600 border-gray-400 bg-gray-800/50 dark:bg-gray-800/50 bg-gray-100/50 text-white dark:text-white text-gray-900 font-mono focus:border-green-400 transition-colors"
                        />
                      </motion.div>
                      ...
                      <motion.div
                        ...
                        transition={{ type: "spring", stiffness: 300 }}
                      >
                        <label className="text-sm font-medium mb-2 block text-green-400 font-mono">const email = *</label>
                        <Input
                          name="email"
                          type="email"
                    ...
                    <motion.div
                      ...
                      transition={{ type: "spring", stiffness: 300 }}
                    >
                      <label className="text-sm font-medium mb-2 block text-green-400 font-mono">const subject = *</label>
                      <Input
                        name="subject"
                    ...
                    <motion.div
                      ...
                      transition={{ type: "spring", stiffness: 300 }}
                    >
                      <label className="text-sm font-medium mb-2 block text-green-400 font-mono">const message = *</label>
                      <Textarea
                        name="message"
                        ...
                        required
                        rows={6}
                        className="border-2 border-gray-600 dark:border-gray-600 border-gray-400 bg-gray-800/50 dark:bg-gray-800/50 bg-gray-100/50 text-white dark:text-white text-gray-900 font-mono focus:border-green-400 transition-colors resize-none"
                      />
                    </motion.div>
                    ...
                    >
                      <Button 
                        ...
                        className="w-full bg-gradient-to-r from-green-500/20 to-blue-500/20 hover:from-green-500/30 hover:to-blue-500/30 text-green-400 dark:text-green-400 text-green-600 border border-green-500/30 font-mono py-4 text-lg font-medium transition-all duration-300"
                      >
                        {isSubmitted ? (
                          <motion.div
                            initial={{ scale: 0 }}
              ...
              <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/80 dark:bg-gray-900/80 bg-white/80 backdrop-blur-sm">
                {/* Terminal Header */}
                <div className="px-3 py-2 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300 font-mono text-xs">
                  <div className="flex items-center gap-2">
                    <span className="text-green-400">$</span>
                    <span className="text-white dark:text-white text-gray-900">ls work_preferences/</span>
                  </div>
                </div>

                <CardContent className="p-6">
                  <h3 className="font-semibold mb-4 flex items-center gap-2 text-green-400 font-mono">
                    ...
                    {workPreferences.map((pref) => (
                      <motion.div
                        ...
                        className={`flex items-center gap-2 p-3 rounded-lg border font-mono ${
                          pref.available 
                            ? 'bg-green-500/10 border-green-500/30 text-green-400 dark:text-green-400 text-green-600' 
                            : 'bg-gray-700/30 dark:bg-gray-700/30 bg-gray-200/30 border-gray-600 dark:border-gray-600 border-gray-400 text-gray-400 dark:text-gray-400 text-gray-500'
                        }`}
                        title={pref.command}
                      >
                        <CheckCircle className={`w-4 h-4 ${
                          pref.available ? 'text-green-400' : 'text-gray-400 dark:text-gray-400 text-gray-500'
                        }`} />
            ...
            >
                ...
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      transition={{ type: "spring", stiffness: 300 }}
                    >
                      <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/80 dark:bg-gray-900/80 bg-white/80 backdrop-blur-sm hover:bg-gray-800/90 dark:hover:bg-gray-800/90 hover:bg-gray-50/90 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                        {/* Terminal Header */}
                        <div className="px-3 py-2 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300 font-mono text-xs">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <span className="text-green-400">$</span>
                              <span className="text-white dark:text-white text-gray-900">{info.command}</span>
                            </div>
                            <Badge className={`text-xs font-mono ${
                              info.status === 'ACTIVE' ? 'bg-green-500/20 text-green-400 border-green-500/30' :
                              info.status === 'AVAILABLE' ? 'bg-blue-500/20 text-blue-400 border-blue-500/30' :
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-semibold font-mono text-white dark:text-white text-gray-900 group-hover:text-green-400 dark:group-hover:text-green-400 group-hover:text-green-600 transition-colors">
                                {info.label}
                              </h3>
                              <motion.a
                                href={info.href}
                                className="text-green-400 font-medium font-mono hover:text-blue-400 transition-colors block mt-1"
                                whileHover={{ x: 5 }}
                              >
                                {info.value}
                              </motion.a>
                              <p className="text-sm text-gray-400 dark:text-gray-400 text-gray-500 mt-2 font-mono">
                                <span className="text-gray-500 dark:text-gray-500 text-gray-400">// </span>
                                {info.description}
                              </p>
                            </div>
              ...
              <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/90 dark:bg-gray-900/90 bg-white/90 backdrop-blur-sm">
                {/* Terminal Header */}
                <div className="px-3 py-2 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300 font-mono text-xs">
                  <div className="flex items-center gap-2">
                    <span className="text-green-400">$</span>
                    <span className="text-white dark:text-white text-gray-900">cat sla.json</span>
                  </div>
                </div>
                ...
                <CardContent className="p-6 text-center">
                  <motion.div
                    animate={{ scale: [1, 1.05, 1] }}
                    transition={{ duration: 2, repeat: Infinity }}
                    className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-green-400 to-blue-400 flex items-center justify-center"
                  >
                    <Clock className="w-8 h-8 text-black" />
                  </motion.div>
                  <h3 className="font-semibold mb-2 font-mono text-green-400">Response SLA</h3>
                  <p className="text-sm text-gray-300 dark:text-gray-300 text-gray-600 mb-4 font-mono">
                    <span className="text-gray-500 dark:text-gray-500 text-gray-400">// </span>
                    Guaranteed response within 24 hours. For urgent projects, call directly.
                  </p>
                  <div className="flex justify-center gap-4">
                    <Badge variant="outline" className="bg-gray-800/50 dark:bg-gray-800/50 bg-gray-100/50 font-mono text-gray-300 dark:text-gray-300 text-gray-600 border-gray-600 dark:border-gray-600 border-gray-400">
                      {availabilityStatus.timezone}
                    </Badge>
                    <Badge variant="outline" className="bg-green-500/20 text-green-400 border-green-500/30 font-mono">
