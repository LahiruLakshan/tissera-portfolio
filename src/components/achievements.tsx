        ...
        >
          ...
          >
            ...
            >
              ...
              Journey of <span className="text-green-400">continuous learning</span>, 
              <span className="text-blue-400"> professional growth</span>, and 
          ...
          <motion.div variants={itemVariants} className="mb-16">
            <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/90 dark:bg-gray-900/90 bg-white/90 backdrop-blur-sm shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300">
                ...
                <span className="text-xs text-gray-400 dark:text-gray-400 text-gray-600 ml-2 font-mono">achievements@portfolio:~$</span>
              </div>
          ...
          >
            <div className="text-center mb-8">
              <h3 className="text-xl font-mono text-green-400 dark:text-green-400 text-gray-900 mb-4">$ ls -la categories/</h3>
            </div>
                  ...
                  >
                    <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/80 dark:bg-gray-900/80 bg-white/80 backdrop-blur-sm hover:bg-gray-800/90 dark:hover:bg-gray-800/90 hover:bg-gray-50/90 transition-all duration-300">
                      ...
                      <div className="px-3 py-2 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300 font-mono text-xs">
                        <div className="flex items-center gap-2">
                          <span className="text-green-400">$</span>
                          <span className="text-white dark:text-white text-gray-900 truncate">{stat.command}</span>
                        </div>
                      </div>
                      ...
                      <CardContent className="p-6 text-center">
                        ...
                        <div className="text-2xl font-bold text-green-400 font-mono mb-1">{stat.count}</div>
          ...
          >
            <div className="text-center mb-12">
              <h3 className="text-2xl font-mono text-green-400 dark:text-green-400 text-gray-900 mb-4">$ git log --graph --milestones</h3>
            </div>
            
            <div className="relative">
              {/* Timeline Line */}
              <motion.div
                className="absolute top-6 left-0 right-0 h-0.5 bg-gradient-to-r from-green-400 via-blue-400 to-green-400"
                initial={{ scaleX: 0 }}
              ...
              <div className="flex justify-between items-center relative">
                {milestones.map((milestone, index) => {
                  ...
                  return (
                    ...
                    >
                      <motion.div
                        className="w-12 h-12 rounded-full bg-gradient-to-r from-green-400 to-blue-400 flex items-center justify-center text-black shadow-lg mb-3 z-10 border-4 border-gray-900 dark:border-gray-900 border-gray-50"
                      ...
                      <div className="text-center">
                        <div className="font-bold text-green-400 font-mono text-sm">{milestone.year}</div>
                        <div className="text-xs text-gray-400 dark:text-gray-400 text-gray-500 max-w-20 leading-tight font-mono">
                          {milestone.event}
                        </div>
                      </div>
                      ...
                      {/* Command Tooltip */}
                      <motion.div
                        className="absolute top-full mt-2 bg-black/90 dark:bg-black/90 bg-white/90 border border-green-500/30 rounded px-2 py-1 font-mono text-xs text-green-300 dark:text-green-300 text-green-600 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h3 className="text-2xl font-mono text-green-400 dark:text-green-400 text-gray-900">$ cat achievements/*.json</h3>
            </div>
              ...
              {achievements.map((achievement, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group"
                  >
                    <Card className="border border-gray-700 dark:border-gray-700 border-gray-300 bg-gray-900/90 dark:bg-gray-900/90 bg-white/90 backdrop-blur-sm hover:bg-gray-800/95 dark:hover:bg-gray-800/95 hover:bg-gray-50/95 hover:shadow-2xl transition-all duration-500 h-full overflow-hidden">
                      {/* Terminal Command Header */}
                      <div className="px-4 py-3 bg-gray-800 dark:bg-gray-800 bg-gray-200 border-b border-gray-700 dark:border-gray-700 border-gray-300 font-mono text-xs">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            <span className="text-green-400">$</span>
                            <span className="text-white dark:text-white text-gray-900">{achievement.command}</span>
                          </div>
                          <Badge
                            variant={achievement.type === "ACADEMIC" ? "default" : "secondary"}
                            className={`text-xs font-mono ${
                              achievement.type === "ACADEMIC" ? 'bg-green-500/20 text-green-400 border-green-500/30' :
                              achievement.type === "COMPETITION" ? 'bg-blue-500/20 text-blue-400 border-blue-500/30' :
                              achievement.type === "PROFESSIONAL" ? 'bg-purple-500/20 text-purple-400 border-purple-500/30' :
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-gray-400 dark:text-gray-400 text-gray-600">Status: {achievement.verification}</span>
                          <span className="text-gray-400 dark:text-gray-400 text-gray-600">{achievement.achievement_date}</span>
                        </div>
                      </div>
                      ...
                      <CardHeader className="pb-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <CardTitle className="text-lg font-mono text-white dark:text-white text-gray-900 group-hover:text-green-400 dark:group-hover:text-green-400 group-hover:text-green-600 transition-colors mb-2 line-clamp-2">
                              {achievement.title}
                            </CardTitle>
                            <div className="space-y-2">
                              <div className="flex items-center gap-2 text-blue-400 dark:text-blue-400 text-blue-600 font-semibold text-sm font-mono">
                                <Building className="w-4 h-4" />
                                {achievement.source}
                              </div>
                              <div className="flex items-center gap-3">
                                <Badge variant="outline" className="text-xs font-mono bg-gray-800/50 dark:bg-gray-800/50 bg-gray-100/50 text-gray-300 dark:text-gray-300 text-gray-600 border-gray-600 dark:border-gray-600 border-gray-400">
                                  {achievement.category}
                                </Badge>
                                <div className="flex items-center gap-1 text-xs text-gray-400 dark:text-gray-400 text-gray-500 font-mono">
                      ...
                      <CardContent className="space-y-6">
                        {/* Description */}
                        <p className="text-gray-300 dark:text-gray-300 text-gray-600 text-sm leading-relaxed">
                        ...
                        {/* Statistics */}
                        <div>
                          <h4 className="font-semibold mb-3 flex items-center gap-2 text-green-400 font-mono text-sm">
                            <FileCode className="w-4 h-4" />
                            stats.json
                          </h4>
                          <div className="grid grid-cols-1 gap-2">
                            {Object.entries(achievement.stats).map(([key, value]) => (
                              <div key={key} className="flex items-center justify-between text-sm bg-gray-800/30 dark:bg-gray-800/30 bg-gray-100/30 rounded-lg p-2 border border-gray-700 dark:border-gray-700 border-gray-300">
                                <span className="text-gray-400 dark:text-gray-400 text-gray-500 capitalize font-mono">{key.replace(/([A-Z])/g, '_$1').toLowerCase()}:</span>
                                <span className="font-medium text-green-400 font-mono">{value}</span>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        {/* Skills Gained */}
                        <div>
                          <h4 className="font-semibold mb-3 flex items-center gap-2 text-blue-400 font-mono text-sm">
                            <Lightbulb className="w-4 h-4" />
                            skills/
                          </h4>
                          <div className="flex flex-wrap gap-2">
                            {achievement.skills.map((skill) => (
                              <Badge key={skill} variant="secondary" className="text-xs font-mono bg-gray-800/50 dark:bg-gray-800/50 bg-gray-100/50 text-gray-300 dark:text-gray-300 text-gray-600 hover:bg-green-500/20 dark:hover:bg-green-500/20 hover:bg-green-600/20 transition-colors">
                                {skill}
                              </Badge>
                            ))}
                          </div>
